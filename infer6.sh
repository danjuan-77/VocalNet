...
python3 omni_speech/infer/vocalnet_batch_infer.py --model_path /mnt/buffer/kangyipeng/checkpoints/VocalNet/llama32-8B-instruct-s2s-mtp-ultravoice100k-clean-all-sft-llm-and-decoder-save-steps200/checkpoint-1600 \
