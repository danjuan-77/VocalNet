...
COSYVOICE_MODEL="/home/tuwenming/Models/FunAudioLLM/CosyVoice2-0.5B"     ## CosyVoice2-0.5B  旧版本，使用cosyvoice.yaml而不是cosyvoice2.yaml    i.e. /workspace/CosyVoice/pretrained_models/CosyVoice2-0.5B-VocalNet 
VOCALNET_MODEL = "/share/nlp/tuwenming/projects/VocalNet/checkpoints/llama32-8B-instruct-s2s-mtp-ultravoice-emotion-test/checkpoint-1563/"    ## VocalNet speech LLM   i.e. ./checkpoints/VocalNet-1B
