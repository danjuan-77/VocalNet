...
VOCALNET_MODEL = "/mnt/buffer/kangyipeng/checkpoints/VocalNet/llama32-8B-instruct-s2s-mtp-ultravoice100k-clean-all-sft-llm-and-decoder-save-steps200/checkpoint-2800"    ## VocalNet speech LLM   i.e. ./checkpoints/VocalNet-1B
