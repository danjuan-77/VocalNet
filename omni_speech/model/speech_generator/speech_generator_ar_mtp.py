...
class SpeechGeneratorARMTP(nn.Module):
    ...
    def predict_mtp(self, llm_hidden, top_k=1, prefix=None, penalty_window_size=0, penalty=2, max_tokens=2048, infer_mtp_token_num=3): # use penalty to control decode strategy
