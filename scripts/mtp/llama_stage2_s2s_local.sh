...
BASE_MODEL="/home/tuwenming/Models/VocalNet/VocalNet-1B" 
DATA_PATH="./playground/ultravoice/ultravoice_accent_AU_5990_test.json"
SPEECH_FOLDER="./playground/"
SPEECH_ENCODER="/home/tuwenming/Models/openai/whisper-large-v3"
